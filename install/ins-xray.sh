...
# download script
cd /usr/bin
wget -O port-xray "https://raw.githubusercontent.com/${GitUser}/newws/main/change-port/port-xray.sh"
wget -O port-trojan "https://raw.githubusercontent.com/${GitUser}/newws/main/change-port/port-trojan.sh"
wget -O certv2ray "https://raw.githubusercontent.com/${GitUser}/newws/main/cert.sh"
wget -O trojaan "https://raw.githubusercontent.com/${GitUser}/newws/main/menu/trojaan.sh"
wget -O xraay "https://raw.githubusercontent.com/${GitUser}/newws/main/menu/xraay.sh"
chmod +x port-xray
chmod +x port-trojan
chmod +x certv2ray
chmod +x trojaan
